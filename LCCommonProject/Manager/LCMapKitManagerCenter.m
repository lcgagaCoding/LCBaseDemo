...
#import "LCMapKitManagerCenter.h"

#define kBDMapKey (@"Rp5NbHja0LngtvBg8sdFzDRXjIDFFQb0")


@interface LCMapKitManagerCenter()
...
@implementation LCMapKitManagerCenter{
...
+ (void)initMapSdk{
    ...
    BOOL ret = [mapManager start:kBDMapKey  generalDelegate:nil];
    if (!ret) {
...
+ (LCMapKitManagerCenter *)sharedInstance{
    ...
    static LCMapKitManagerCenter *mc = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        mc = [[LCMapKitManagerCenter alloc]init];
    });
